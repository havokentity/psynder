...
3. **§16 ADR log** — the nine ADR slots are the load-bearing answers. Each one closes off a question a contributor would otherwise relitigate. Seven decided (1, 2, 3, 4, 7, 8, 9), two not-applicable (5, 6).
