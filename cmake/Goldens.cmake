...
function(psynder_add_golden_cell)
    ...
    if(NOT DEFINED GOLD_FRAMES)        ; set(GOLD_FRAMES 30)        ; endif()
    if(NOT DEFINED GOLD_MAX_DELTA)     ; set(GOLD_MAX_DELTA 16)     ; endif()
    if(NOT DEFINED GOLD_MEAN_DELTA)    ; set(GOLD_MEAN_DELTA 2)     ; endif()
    if(NOT DEFINED GOLD_FAIL_PERCENT)  ; set(GOLD_FAIL_PERCENT 1)   ; endif()
