...
const ChipSong& boot_chime_song() {
    static constexpr ChipNote kNotes[]{
        // Bright arcade boot fanfare: clean major lift instead of ominous drift.
        {.start_tick = 0,
         .duration_ticks = 8,
         .midi_note = 48,
         .velocity = 118,
        ...
        // Very light chip percussion, just enough snap.
        {.start_tick = 0,
         .duration_ticks = 1,
         .midi_note = 55,
         .velocity = 32,
        ...
        // Final resolve: optimistic and buttoned-up.
        {.start_tick = 30,
         .duration_ticks = 2,
         .midi_note = 88,
         .velocity = 132,
