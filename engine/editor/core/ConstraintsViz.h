...
PSY_FORCEINLINE u32 color_for_kind(constraints::Kind k) noexcept {
    switch (k) {
        case constraints::Kind::Weld:       return 0xE03333FFu;
        case constraints::Kind::Axis:       return 0x33CCEEFFu;
        case constraints::Kind::Slider:     return 0xEED633FFu;
        case constraints::Kind::BallSocket: return 0xCC55CCFFu;
        case constraints::Kind::Rope:       return 0xBBAA77FFu;
        case constraints::Kind::Elastic:    return 0x77EE55FFu;
    }
    return 0xFFFFFFFFu;
}
...
inline Projected project_anchor(const Camera& cam,
                                math::Vec3 body_pos, math::Quat body_rot,
    ...
    const math::Vec4 w = math::mul(mr, math::Vec4{anchor_local.x, anchor_local.y, anchor_local.z, 1.0f});
...
inline void build_constraint_lines(std::vector<ScreenSegment>& out,
    ...
    switch (c.kind) {
        ...
        case constraints::Kind::Axis: {
            ...
            const math::Vec3 tip_w = math::add(math::add(pa.position, c.anchor_a),
                                               math::mul(ax, 0.5f));
        ...
        case constraints::Kind::Slider: {
            ...
            math::Vec3 perp = std::fabs(ax.y) > 0.99f
                ? math::cross(ax, math::Vec3{1,0,0})
