   ...
   public:
    ...
    void i16_(::psynder::i16 v) {
        if (v >= 0) {
            ...
            put1(0xD1);
            put_be16(static_cast<::psynder::u16>(v));
        }
    }
    ...
    void i64_(::psynder::i64 v) {
        if (v >= 0) {
            ...
            put1(0xD3);
            put_be64(static_cast<::psynder::u64>(v));
        }
    }
    ...
    void str(std::string_view s) {
        ...
        if (n <= 31) {
            ...
            put1(0xD9);
            put1(static_cast<::psynder::u8>(n));
        } else if (n <= 0xFFFF) {
            put1(0xDA);
            put_be16(static_cast<::psynder::u16>(n));
        } else {
            put1(0xDB);
            put_be32(static_cast<::psynder::u32>(n));
        }
...
class Reader {
   public:
    ...
    Reader(const std::vector<::psynder::u8>& v) noexcept : Reader(v.data(), v.size()) {}
    ...
    bool u8_(::psynder::u8& v) noexcept {
        ::psynder::u64 x = 0;
        if (!u64_(x) || x > 0xFFull)
            return false;
        v = static_cast<::psynder::u8>(x);
        return true;
    }
    bool u16_(::psynder::u16& v) noexcept {
        ::psynder::u64 x = 0;
        if (!u64_(x) || x > 0xFFFFull)
            return false;
        v = static_cast<::psynder::u16>(x);
        return true;
    }
    bool u32_(::psynder::u32& v) noexcept {
        ::psynder::u64 x = 0;
        if (!u64_(x) || x > 0xFFFFFFFFull)
            return false;
        v = static_cast<::psynder::u32>(x);
        return true;
    }
    bool u64_(::psynder::u64& v) noexcept {
        ...
        switch (tag) {
            ...
            case 0xD1: {
                ...
                if (!read_be16(x))
                    return false;
                if (static_cast<::psynder::i16>(x) < 0)
                    return false;
                v = x;
                return true;
            }
            case 0xD2: {
                ...
                if (!read_be32(x))
                    return false;
                if (static_cast<::psynder::i32>(x) < 0)
                    return false;
                v = x;
                return true;
            }
            case 0xD3: {
                ...
                if (!read_be64(x))
                    return false;
                if (static_cast<::psynder::i64>(x) < 0)
                    return false;
                v = x;
                return true;
            }
    ...
    bool i8_(::psynder::i8& v) noexcept {
        ::psynder::i64 x = 0;
        if (!i64_(x) || x < -128 || x > 127)
            return false;
        v = static_cast<::psynder::i8>(x);
        return true;
    }
    bool i16_(::psynder::i16& v) noexcept {
        ::psynder::i64 x = 0;
        if (!i64_(x) || x < -32768 || x > 32767)
            return false;
        v = static_cast<::psynder::i16>(x);
        return true;
    }
    bool i32_(::psynder::i32& v) noexcept {
        ::psynder::i64 x = 0;
        if (!i64_(x) || x < -0x80000000ll || x > 0x7FFFFFFFll)
            return false;
        v = static_cast<::psynder::i32>(x);
        return true;
    }
    ...
    bool f32_(::psynder::f32& v) noexcept {
        ...
        if (tag == 0xCB) {
            ...
            if (!f64_(d))
                return false;
            v = static_cast<::psynder::f32>(d);
            return true;
        }
        // Allow integer → float widening for robustness.
        ::psynder::i64 ix = 0;
        if (i64_(ix)) {
            v = static_cast<::psynder::f32>(ix);
            return true;
        }
        return false;
    }
    bool f64_(::psynder::f64& v) noexcept {
        ...
        if (tag == 0xCA) {
            ...
            if (!f32_(f))
                return false;
            v = static_cast<::psynder::f64>(f);
            return true;
        }
        ::psynder::i64 ix = 0;
        if (i64_(ix)) {
            v = static_cast<::psynder::f64>(ix);
            return true;
        }
        return false;
    }
   ...
   private:
    ...
    bool read_be16(::psynder::u16& v) noexcept {
        if (remaining() < 2)
            return false;
        v = static_cast<::psynder::u16>((p_[0] << 8) | p_[1]);
        p_ += 2;
        return true;
    }
...
inline void encode(Writer& w, bool v) {
    w.boolean(v);
}
inline void encode(Writer& w, ::psynder::u8 v) {
    w.u8_(v);
}
inline void encode(Writer& w, ::psynder::u16 v) {
    w.u16_(v);
}
inline void encode(Writer& w, ::psynder::u32 v) {
    w.u32_(v);
}
inline void encode(Writer& w, ::psynder::u64 v) {
    w.u64_(v);
}
inline void encode(Writer& w, ::psynder::i8 v) {
    w.i8_(v);
}
inline void encode(Writer& w, ::psynder::i16 v) {
    w.i16_(v);
}
inline void encode(Writer& w, ::psynder::i32 v) {
    w.i32_(v);
}
inline void encode(Writer& w, ::psynder::i64 v) {
    w.i64_(v);
}
inline void encode(Writer& w, ::psynder::f32 v) {
    w.f32_(v);
}
inline void encode(Writer& w, ::psynder::f64 v) {
    w.f64_(v);
}
inline void encode(Writer& w, std::string_view v) {
    w.str(v);
}
inline void encode(Writer& w, const std::string& v) {
    w.str(v);
}
...
inline bool decode(Reader& r, ::psynder::u8& v) {
    return r.u8_(v);
}
inline bool decode(Reader& r, ::psynder::u16& v) {
    return r.u16_(v);
}
inline bool decode(Reader& r, ::psynder::u32& v) {
    return r.u32_(v);
}
inline bool decode(Reader& r, ::psynder::u64& v) {
    return r.u64_(v);
}
inline bool decode(Reader& r, ::psynder::i8& v) {
    return r.i8_(v);
}
inline bool decode(Reader& r, ::psynder::i16& v) {
    return r.i16_(v);
}
inline bool decode(Reader& r, ::psynder::i32& v) {
    return r.i32_(v);
}
inline bool decode(Reader& r, ::psynder::i64& v) {
    return r.i64_(v);
}
inline bool decode(Reader& r, ::psynder::f32& v) {
    return r.f32_(v);
}
inline bool decode(Reader& r, ::psynder::f64& v) {
    return r.f64_(v);
}
inline bool decode(Reader& r, std::string& v) {
    return r.str(v);
}
