...
class Reliability {
   public:
    ...
    u32 apply_ack_wide(u32 ack_base, u32 bits_lo, u32 bits_hi, u32 bits_hi2, u32 bits_hi3) noexcept;
    ...
    u32 collect_retransmits(u32 now_tick, u32 rto_ticks, std::vector<u32>& out_indices) noexcept;
...
class AckTracker {
   public:
    ...
    explicit AckTracker(WindowSize sz) noexcept : window_bits_(static_cast<u32>(sz)) {}
