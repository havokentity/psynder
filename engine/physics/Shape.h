...
PSY_FORCEINLINE math::Vec3
quat_rotate(math::Quat q, math::Vec3 v) noexcept {
...
inline math::Aabb
aabb_world(u8 shape, math::Vec3 half_extent,
           math::Vec3 position, math::Quat rotation) noexcept {
    ...
    f32 r;
    switch (shape) {
        case 0:  r = half_extent.x; break;                              // Sphere
        case 1:  r = half_extent.x + half_extent.y; break;              // Capsule
        case 2: {                                                       // Box
        ...
        default: r = half_extent.x; break;                              // hull/etc.
    }
