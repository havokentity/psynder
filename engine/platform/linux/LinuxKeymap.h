...
constexpr KeyCode keycode_from_evdev(std::uint32_t c) noexcept {
    ...
    case KEY_GRAVE:      return KeyCode::Tilde;
    case KEY_LEFTSHIFT:  return KeyCode::LeftShift;
    case KEY_RIGHTSHIFT: return KeyCode::RightShift;
    case KEY_LEFTCTRL:   return KeyCode::LeftCtrl;
    case KEY_RIGHTCTRL:  return KeyCode::RightCtrl;
    case KEY_LEFTALT:    return KeyCode::LeftAlt;
    case KEY_RIGHTALT:   return KeyCode::RightAlt;
    ...
    default:
        ...
        if (k >= XK_a && k <= XK_z) {
            return static_cast<KeyCode>(
                static_cast<std::uint16_t>(KeyCode::A) + (k - XK_a));
        }
...
constexpr BlitRect compute_blit_rect(int window_w,
                                     int window_h,
                                     int render_w,
                                     int render_h,
                                     AspectMode mode,
