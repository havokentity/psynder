...
inline constexpr u8 kEligibleMask =
    kLightmapNearest | kNoDynamicLights | kNoNormalMap |
    kLdrLightmap    | kStableMip;
}  // namespace draw_flags
...
public:
    ...
    u32 acquire(u32 surface_id, u32 lightmap_version, u32 mip_level,
                u32 width, u32 height, u32 byte_size) noexcept;
