...
TEST_CASE("samples_tests: identical images report zero mismatch",
          "[lane25][golden]") {
...
TEST_CASE("samples_tests: tiny per-channel delta is within tolerance",
          "[lane25][golden]") {
...
TEST_CASE("samples_tests: any channel above eps counts as a mismatch",
          "[lane25][golden]") {
    Image a = solid(4, 4, 100, 150, 200);
...
TEST_CASE("samples_tests: partial mismatch reports exact percentage",
          "[lane25][golden]") {
...
TEST_CASE("samples_tests: differing sizes refuse to compare",
          "[lane25][golden]") {
...
TEST_CASE("samples_tests: tolerance bar honours DESIGN.md §14 0.5%",
          "[lane25][golden]") {
